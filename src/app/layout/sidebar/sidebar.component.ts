...
export class SidebarComponent {
  ...
  allNavItems: NavItem[] = [
    ...
    { title: 'Trainings', image: 'assets/images/training-sessions.png', route: '/admin/training-sessions' },
    { title: 'Enrollment', image: 'assets/images/enroll.png', route: '/admin/enrollment' }];
    navItems: NavItem[] = [];
  ngOnInit() {
    this.setupSidebarBasedOnRole();
  }
  private setupSidebarBasedOnRole(): void {
